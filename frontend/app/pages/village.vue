<template>
  <div class="village-layout">
    ...
    <!-- エラー -->
    <div v-else-if="hasError" class="flex h-dvh w-full items-center justify-center bg-gray-100">
    ...
    <!-- メインコンテンツ -->
    <div v-else class="flex h-full w-full" :class="{ 'dark-theme': isDarkTheme }">
...
const { theme, hasFixedPanel, isFixedPanelOpen, loadFromCookie } = useUserSettings();
