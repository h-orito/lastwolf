  ...
  <div class="menu-wrap">
    ...
    <div class="menu-area">
      ...
      <div v-else-if="villages">
        ...
        <div v-if="villages.list?.length > 0" class="mb-8 grid gap-4 md:grid-cols-2">
          <VillageCard v-for="village in villages.list" :key="village.id" :village="village" />
        </div>
        <p v-else class="mb-8 text-gray-400">現在開催中の村はありません</p>

        <!-- ボタンエリア -->
        <div class="grid gap-4 md:grid-cols-2">
          <SpotlightButton v-if="canCreateVillage" to="/create-village"> 村を作成 </SpotlightButton>
