<template>
  <div class="rounded-lg bg-white p-6 shadow">
    ...
    <div class="space-y-4">
      <!-- 年齢制限 -->
      <div>
        <label class="mb-2 block text-center text-sm font-medium text-gray-700"> 年齢制限 </label>
        <FormSelect
          v-model="ageLimit"
        ...
        />
        <p v-if="props.errors?.ageLimit" class="mt-1 text-center text-xs text-red-600">
      ...
      <!-- 見学発言制限 -->
      <div v-if="availableSpectate" class="rounded-lg border border-gray-200 p-4">
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div>
            ...
            />
            <p v-if="props.errors?.spectateCount" class="mt-1 text-xs text-red-600">
          ...
          <div>
            ...
            />
            <p v-if="props.errors?.spectateLength" class="mt-1 text-xs text-red-600">
      ...
      <div v-if="availableAction" class="rounded-lg border border-gray-200 p-4">
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div>
            ...
            />
            <p v-if="props.errors?.actionCount" class="mt-1 text-xs text-red-600">
          ...
          <div>
            ...
            />
            <p v-if="props.errors?.actionLength" class="mt-1 text-xs text-red-600">
