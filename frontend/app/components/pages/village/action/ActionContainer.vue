<template>
  <div v-if="existsAction" class="action-container mx-auto flex max-w-[640px] flex-col gap-4 py-4">
    <!-- 発言 -->
    ...
    <!-- 村建てメニュー -->
    <CreatorMenu v-if="isDispCreatorMenu" @complete="handleCreatorMenuComplete" />
...
const isDispLeave = computed(() => situation.value?.participate.available_leave ?? false);
...
const isDispAdminMenu = computed(() => false);
