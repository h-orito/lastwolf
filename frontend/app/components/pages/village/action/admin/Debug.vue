<template>
  <ActionPanel title="デバッグメニュー" panel-key="debug">
    ...
    <!-- 参加させる -->
    <div class="mb-4">
      <p class="mb-2 text-sm font-bold text-gray-700 dark:text-gray-300">参加させる</p>
    ...
    <!-- ダミーログイン -->
    <div class="mb-4">
      <p class="mb-2 text-sm font-bold text-gray-700 dark:text-gray-300">ダミーログイン</p>
      <div class="flex gap-2">
        <FormSelect v-model="playerId" :options="playerList" size="sm" class="flex-1" />
        <UiButton
          :disabled="submitting"
          :loading="submitting"
          color="primary"
    ...
    <!-- 突然死なしにする -->
    <div class="mb-4">
      <p class="mb-2 text-sm font-bold text-gray-700 dark:text-gray-300">突然死なしにする</p>
    ...
    <!-- 日付を進める -->
    <div class="mb-4">
      <p class="mb-2 text-sm font-bold text-gray-700 dark:text-gray-300">日付を進める</p>
      <div class="flex justify-end">
        <UiButton
          :disabled="submitting"
          :loading="submitting"
    ...
    <!-- 100回発言する -->
    <div>
      <p class="mb-2 text-sm font-bold text-gray-700 dark:text-gray-300">100回発言する</p>
      <div class="flex justify-end">
        <UiButton
          :disabled="submitting"
          :loading="submitting"
...
const dummyLoginCharaName = (participant: VillageParticipantView): string => {
  const name = participant.chara.name.name;
