<template>
  <div>
    ...
    <p class="mb-2 font-bold text-fg">点呼</p>
    <p v-if="!rollcalling" class="mb-2 text-fg">準備ができたら準備完了を押してください。</p>
    <p v-if="rollcalling" class="mb-2 text-fg">他の方が準備完了するまでお待ちください。</p>
