  ...
  <Modal v-model="isModalOpen" title="発言抽出">
    ...
    <template #footer>
      <div class="flex justify-end gap-2">
        <UiButton color="secondary" variant="outline" @click="handleReset"> リセット </UiButton>
        <UiButton color="secondary" variant="outline" @click="handleClose"> キャンセル </UiButton>
        <UiButton color="primary" :disabled="!canFilter" @click="handleFilter"> 抽出する </UiButton>
      </div>
    </template>
  </Modal>
</template>
