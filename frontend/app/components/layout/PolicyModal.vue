<template>
  <Modal v-model="isOpen" title="プライバシーポリシー" @close="close">
    <div class="content max-h-96 overflow-y-auto text-sm">
      ...
      <h3 class="mb-2 font-semibold">第3条（プライバシー情報を収集・利用する目的）</h3>
      <p class="mb-2">本サービスが個人情報を収集・利用する目的は，以下のとおりです。</p>
      <ol class="mb-3 list-decimal pl-5">
        <li>サービスの提供・運営のため</li>
      ...
      <h3 class="mb-2 font-semibold">第7条（プライバシー情報の訂正および削除）</h3>
      <ol class="mb-3 list-decimal pl-5">
        <li>
      ...
      <p class="mb-3">本ポリシーに関するお問い合わせは，Twitter @ort_devまでお願いいたします。</p>
    </div>
