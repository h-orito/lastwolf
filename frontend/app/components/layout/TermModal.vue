<template>
  <Modal v-model="isOpen" title="利用規約" @close="close">
    <div class="content max-h-96 overflow-y-auto text-sm">
      ...
      <h3 class="mb-2 font-semibold">第3条（ユーザIDおよびパスワードの管理）</h3>
      <ol class="mb-3 list-decimal pl-5">
        <li>
      ...
      <h3 class="mb-2 font-semibold">第4条（禁止事項）</h3>
      <p class="mb-2">ユーザは，本サービスの利用にあたり，以下の行為をしてはなりません。</p>
      <ol class="mb-3 list-decimal pl-5">
      ...
      <h3 class="mb-2 font-semibold">第5条（本サービスの提供の停止等）</h3>
      <ol class="mb-3 list-decimal pl-5">
        <li>
      ...
      <h3 class="mb-2 font-semibold">第6条（利用制限および登録抹消）</h3>
      <ol class="mb-3 list-decimal pl-5">
        <li>
      ...
      <h3 class="mb-2 font-semibold">第7条（退会）</h3>
      <p class="mb-3">
        ユーザは，管理人の定める退会手続により，本サービスから退会できるものとします。
      </p>
      <h3 class="mb-2 font-semibold">第8条（保証の否認および免責事項）</h3>
      <ol class="mb-3 list-decimal pl-5">
        <li>
      ...
      <h3 class="mb-2 font-semibold">第13条（権利義務の譲渡の禁止）</h3>
      <p class="mb-3">
        ユーザは，管理人の書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。
      </p>
      <h3 class="mb-2 font-semibold">第14条（準拠法・裁判管轄）</h3>
      <ol class="mb-3 list-decimal pl-5">
