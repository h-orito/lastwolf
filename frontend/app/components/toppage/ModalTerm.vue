<template>
  <UiModal v-model="isOpen" title="利用規約" @close="close">
    <div class="text-sm space-y-4">
      <h3 class="font-semibold text-base">利用規約</h3>
      <p>
      ...
      <h3 class="font-semibold text-base">第1条（適用）</h3>
      ...
      <h3 class="font-semibold text-base">第2条（利用登録）</h3>
      <ol class="list-decimal pl-5 space-y-1">
        <li>
      ...
      <h3 class="font-semibold text-base">第3条（ユーザIDおよびパスワードの管理）</h3>
      <ol class="list-decimal pl-5 space-y-1">
        <li>
      ...
      <h3 class="font-semibold text-base">第4条（禁止事項）</h3>
      ...
      <h3 class="font-semibold text-base">第5条（本サービスの提供の停止等）</h3>
      <ol class="list-decimal pl-5 space-y-1">
        <li>
      ...
      <h3 class="font-semibold text-base">第6条（利用制限および登録抹消）</h3>
      <ol class="list-decimal pl-5 space-y-1">
        <li>
      ...
      <h3 class="font-semibold text-base">第7条（退会）</h3>
      <p>ユーザは，管理人の定める退会手続により，本サービスから退会できるものとします。</p>
      <h3 class="font-semibold text-base">第8条（保証の否認および免責事項）</h3>
      <ol class="list-decimal pl-5 space-y-1">
        <li>
      ...
      <h3 class="font-semibold text-base">第13条（権利義務の譲渡の禁止）</h3>
      <p>
        ユーザは，管理人の書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。
      </p>
      <h3 class="font-semibold text-base">第14条（準拠法・裁判管轄）</h3>
      <ol class="list-decimal pl-5 space-y-1">
