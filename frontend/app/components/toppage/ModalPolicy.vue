<template>
  <UiModalModal v-model="isOpen" title="プライバシーポリシー" @close="close">
    <div class="text-sm space-y-4">
      ...
      <h3 class="font-semibold text-base">第1条（プライバシー情報）</h3>
      ...
      <h3 class="font-semibold text-base">第2条（プライバシー情報の収集方法）</h3>
      <ol class="list-decimal pl-5 space-y-1">
        <li>
      ...
      <h3 class="font-semibold text-base">第3条（プライバシー情報を収集・利用する目的）</h3>
      ...
      <h3 class="font-semibold text-base">第4条（利用目的の変更）</h3>
      <p>
      ...
      <h3 class="font-semibold text-base">第5条（個人情報の第三者提供）</h3>
      <p>
      ...
      <h3 class="font-semibold text-base">第6条（プライバシー情報の開示）</h3>
      <p>Twitterアカウント名やユーザ名以外の情報については，原則として開示いたしません。</p>
      <h3 class="font-semibold text-base">第7条（プライバシー情報の訂正および削除）</h3>
      <ol class="list-decimal pl-5 space-y-1">
        <li>
      ...
      <h3 class="font-semibold text-base">第8条（プライバシー情報の利用停止等）</h3>
      <ol class="list-decimal pl-5 space-y-1">
        <li>
      ...
      <h3 class="font-semibold text-base">第9条（プライバシーポリシーの変更）</h3>
      <ol class="list-decimal pl-5 space-y-1">
        <li>
      ...
      <h3 class="font-semibold text-base">第10条（お問い合わせ窓口）</h3>
