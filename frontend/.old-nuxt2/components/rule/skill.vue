    ...
    >
      <template slot-scope="props">
        ...
        <b-table-column field="ability" label="能力">
          <template>
            <span v-for="(ability, index) in props.row.abilities" :key="ability.name">
              {{ index !== 0 ? "," : "" }}
        ...
        <b-table-column field="divine_result" label="占い結果">
          <template>
            <p :class="props.row.divine_result === '人狼' ? 'has-text-danger' : ''">
        ...
        <b-table-column field="psychic_result" label="霊視結果">
          <template>
            <p :class="props.row.psychic_result === '人狼' ? 'has-text-danger' : ''">
        ...
        <b-table-column field="count_camp" label="勝敗判定カウント" centered>
          <template>
            <p :class="props.row.count_camp === '人狼' ? 'has-text-danger' : ''">
