<template>
  <div>
    ...
    <p class="m-b-10">
      あなたは時短を希望
      <strong class="is-size-6">{{ isCurrentCommitting ? "しています" : "していません" }}</strong>
      。
    </p>
    <b-button :disabled="submitting" @click="setCommit" type="is-primary" size="is-small">{{
...
export default class CommitV extends Vue {
  ...
  private get nextNoonnight(): string {
    ...
    return latestDay.noon_night.code === NOONNIGHT_CODE.NOON ? "投票時間" : "議論時間";
  }
