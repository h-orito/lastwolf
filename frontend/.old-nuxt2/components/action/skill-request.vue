<template>
  <div>
    ...
    <b-button :disabled="!canSubmit || submitting" @click="change" type="is-primary" size="is-small"
      >変更する</b-button
    >
  </div>
</template>
...
export default class SkillRequest extends Vue {
  ...
  private get canSubmit(): boolean {
    return this.firstRequestSkillCode != null && this.secondRequestSkillCode != null;
  }
