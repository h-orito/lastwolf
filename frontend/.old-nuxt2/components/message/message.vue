  ...
  <div class="village-message message-border" :class="messageClass">
    ...
    <div class="message-content-area">
      ...
      <div class="message-text-area">
        <span class="message-content" :class="message.content.strong ? 'message-strong' : ''">{{
...
export default class MessageV extends Vue {
  ...
  private get fromName(): string {
    ...
    if (this.message.content.type.code === MESSAGE_TYPE.CREATOR_SAY) return "村建て";
    return "システム";
  }

  private get messageTime(): string {
    if (this.isPrologue || this.isEpilogue) {
      return dayjs.unix(this.message.time.unix_time_milli / 1000).format("HH:mm");
    }
